...
function preload() {
  img = loadImage('data/photo.jpeg');

  shapes = [];
  shapes.push(loadImage('data/1.svg'));
  shapes.push(loadImage('data/2.svg'));
  shapes.push(loadImage('data/3.svg'));
  shapes.push(loadImage('data/4.svg'));
  shapes.push(loadImage('data/5.svg'));
  shapes.push(loadImage('data/6.svg'));
  shapes.push(loadImage('data/7.svg'));
  shapes.push(loadImage('data/12.svg'));
  shapes.push(loadImage('data/8.svg'));
  shapes.push(loadImage('data/9.svg'));
